...
export function dailyPicks(season,day) {const n=Math.floor(+parseDay(day)/DAY);return Array.from({length:Math.min(3,season.pool.length)},(_,i)=>season.pool[(n+i)%season.pool.length]);}
